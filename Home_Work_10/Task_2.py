...
class House:
    def __init__(self, food=50, money=0 ):
        self.food = food # Кол-во еды в доме
        self.money = money # Кол-во денег в доме

    def buy_food(self, quantity, price):
        """Покупка еды: увеличивает кол-во еды и уменьшает кол-во денег."""
        if self.money >= price:
            self.food += quantity
            self.money -= price
    ...
    def earn_money(self, salary):
        """Заработок денег: увеличиваает кол-во денег в доме."""
        self.money += salary
...
class Human:
    def __init__(self, name, house):
        self.name = name # Name cheloveka
        self.hunger = 50 # Citost cheloveka (start = 50)
        self.house = house # Dom, v kotorom live human

    def eat(self):
        """Метод, который увеличивает сытость человека и уменьшает кол-во еды в доме"""
    ...
    def work(self):
        """Метод который уменьшает сытость человека и увеличивает кол-во денег в доме"""
        self.hunger -= 10
...
human2 = Human("Витас", house1)

house2 = House()
human3 = Human("СерегаЛеха", house2)
