...
def how_are_you(func: Callable[..., Any]) -> Callable[..., Any]:
    """
    Декоратор, который спрашивает у пользователя 'Как дела?' и выводит
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        """
        input('Как дела? ') # запрашивем ответ у пользователя
        print('А у меня не оченЬ! Ладно держи свою функицю.') #Выводим сообщение
